...
export default function Scannow() {
    ...
    const [show, setShow] = useState(!scanResult);
    ...
    return (
        <div className="flex flex-col p-10 items-center">
            ...
            <p className={`${scanResult ? "" : "py-5"} font-mono font-bold`}>{scanResult}</p>
            <div className="w-80 #formDiv">
                {
                    isError && <TranslateClient lang={params.lang} text={"scanner_error"}
                                                className={"error flex flex-col items-center text-red-700 transition duration-500"}/>
                }
                <div role="status" className={`items-center flex flex-col ${isLoading ? "" : "hidden"}`}>
                    ...
                    <TranslateClient lang={params.lang} text={"loading"} className={"sr-only"}/>
                </div>
                {
                    show &&
                    <Scanner
