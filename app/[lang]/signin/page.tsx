...
import {loginRoute, homePage} from "@/components/routerhelper";
...
export default function CustomLogin() {
    ...
    return (
        <div className={" flex flex-col items-center justify-between pt-20"}>
            ...
            <TranslateClient lang={params.lang} text={"app_title"}
                             className={"text-2xl font-bold text-center "}/>
            <TranslateClient lang={params.lang} text={"button_nav_login"}
