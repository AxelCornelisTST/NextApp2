...
export class Migration1713904383151 implements MigrationInterface {
    name = 'Migration1713904383151'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`laptopUser\` (\`user_id\` int NOT NULL, \`email_ouder1\` varchar(255) NOT NULL, \`email_ouder2\` varchar(255) NOT NULL, \`family_name\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, PRIMARY KEY (\`user_id\`)) ENGINE=InnoDB`);
