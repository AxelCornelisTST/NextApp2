...
export class Migration1714385368110 implements MigrationInterface {
    name = 'Migration1714385368110'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`laptopUser\` (\`user_id\` int NOT NULL, \`email_ouder1\` varchar(255) NOT NULL, \`email_ouder2\` varchar(255) NOT NULL, \`family_name\` varchar(255) NOT NULL, \`first_name\` varchar(255) NOT NULL, PRIMARY KEY (\`user_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`laptop\` (\`serial_number\` varchar(255) NOT NULL, \`brand\` varchar(255) NOT NULL, \`model\` varchar(255) NOT NULL, \`processor\` varchar(255) NOT NULL, \`laptop_user_user_id\` int NULL, PRIMARY KEY (\`serial_number\`)) ENGINE=InnoDB`);
