...
export class Migration1715173011946 implements MigrationInterface {
    name = 'Migration1715173011946'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`laptop\` (\`serial_number\` varchar(255) NOT NULL, \`brand\` varchar(255) NOT NULL, \`model\` varchar(255) NOT NULL, \`processor\` varchar(255) NOT NULL, \`is_being_repaired\` tinyint(1) NOT NULL, \`laptop_user_user_id\` int NULL, PRIMARY KEY (\`serial_number\`)) ENGINE=InnoDB`);
